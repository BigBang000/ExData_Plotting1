...
if(0){
par(mfrow = c(2,2))
plot(as.POSIXct(time_stamp), pwr_consump_2days$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")

plot(as.POSIXct(time_stamp), pwr_consump_2days$Voltage, type = "l", ylab = "Voltage", xlab = "")
...
plot(as.POSIXct(time_stamp), pwr_consump_2days$Global_reactive_power, type = "l", ylab = "Global Reactive Power", xlab = "")
}
...
plot(as.POSIXct(time_stamp), pwr_consump_2days$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
...
plot(as.POSIXct(time_stamp), pwr_consump_2days$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")
dev.off()
